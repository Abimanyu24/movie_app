...
interface MovieInfoPros {
  label: string;
  value?: string | number | null;
}
const MovieInfo = ({label, value}: MovieInfoPros) => (
        ...
        <View className="bg-primary flex-1">
          ...
          >
            ...
            <View className="items-start justify-center mt-5 px-5">
              ...
              <View className="flex-row items-center bg-100 px-2 py-1 rounded-md gap-x-1 mt-2">
          ...
          <TouchableOpacity
            className="botton-5 left-0 right-0 mx-5 bg-accent 
